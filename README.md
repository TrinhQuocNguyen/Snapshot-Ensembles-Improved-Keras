# Acknowledge
Thank you to: https://github.com/titu1994/Snapshot-Ensembles

# Snapshot Ensembles in Keras

Implementation of the paper [Snapshot Ensembles: Train 1, Get M for Free](http://openreview.net/pdf?id=BJYwwY9ll) in Keras
...
# model.fit(trainX, trainY, callbacks=snapshot.get_callbacks(model_prefix=model_prefix, is_super=False)) if you want to use constant cycle strategy 
```
